...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="goodsCatelogSelect()" leftmargin="8" topmargin="8" background='<%=path %>/images/allbg.gif'>
			<form action="<%=path %>/goodsAdd.action" name="formAdd" method="post">
				     <table width="98%" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <table>
						           <tr>
						               <td>
						                  <select name="goodsCatelogId" id="goodsCatelogId" style="width: 200px;">
								          </select>
						               </td>
						               <td>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <FCK:editor instanceName="goodsMiaoshu"  basePath="/fckeditor" width="900" height="160" value="请输入内容" toolbarSet="Basic">
                                </FCK:editor>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="goodsShichangjia" style="width: 300px;"
						        value="20"
